                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="code_assets" name="code_assets" placeholder="Kode Asset" value="<?= $data['code_assets'] ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="name_assets">Nama Asset</label>
                                            <input type="text" class="form-control" id="name_assets" name="name_assets" placeholder="Nama Asset">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Deskripsi</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="desc_assets"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" name="type_brand_id" data-live-search="true" required>
                                                ...
                                                <?php foreach ($data['type_brand'] as $key) : ?>
                                                    <option value="<?= $key['id_type_brand'] ?>" data-tokens="<?= $key['id_type_brand'] ?>"><?= $key['type'] ?> - <?= $key['brand'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
