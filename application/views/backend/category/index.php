         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form action="" method="POST" id="form_edit">
                     <input type="hidden" class="form-control" id="id_category" name="id_category" aria-describedby="emailHelp" required>
                     <div class="form-group">
                         <label for="category">Kategori</label>
                         <input type="text" class="form-control" id="category" name="category" aria-describedby="emailHelp" required>
                     </div>
 ...
 <script>
                 ...
                 },
                 {
                     render: function(data, type, full, meta) {
                         return `<div class="container">
                                    <button title="Edit" onclick="edit('${full.id_category}','${full.category}')" type="button" class="btn btn-success"><i class="fa fa-edit"></i></button>
                                    <button onclick="hapus('${full.id_category}')" type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                </div>`;
                     },
                     width: "20%",
                     className: "text-center",
     ...
     function edit(id, value) {
         ...
         $('#editModal #category').val(value)
         $('#editModal #id_category').val(id)
     }
